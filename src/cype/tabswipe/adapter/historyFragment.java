...
import cype.history.adapter.HistoryChildren;
import cype.history.adapter.HistoryExpandableAdapter;
import cype.history.adapter.ProcessingHistory;
import cype.history.adapter.history;
...
public class historyFragment extends Fragment {
	...
	HistoryExpandableAdapter listAdapter;
    ExpandableListView expListView;
    List<history> listDataHeader;
    HashMap<history, List<HistoryChildren>> listDataChild;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
	{
        ...
        ProcessingHistory ph = new ProcessingHistory(getActivity(), RootView);
        ph.processHistory();
		//prepareList();
